...
public class Actions {
	...
	/**
	 * Localiza elemento com tentativas de recuperação
	 */
	...
	/**
	 * Executa ação com tentativas de recuperação
	 */
	...
	/**
	 * Escreve em um elemento com tratamento de erro
	 */
	...
	public void validarTextoElementoContens(By by, String textoEsperado) {
		String textoElemento = localizarElementoComTentativas(by).getText();
		Log.registrar("Validar texto contido. Esperado conter: " + textoEsperado + " | Encontrado: " + textoElemento);
		Assert.assertTrue(textoElemento.contains(textoEsperado));
	}
}
